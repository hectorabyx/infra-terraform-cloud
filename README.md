...
1. An example Terraform configuration which provisions some mock infrastructure to a fictitious cloud provider called " Web Services" using the [`webservices`](https://registry.terraform.io/providers/hashicorp/webservices/latest) provider.
...
```sh
git clone https://github.com/hectorabyx/infra-terraform-cloud
